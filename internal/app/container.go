...
func BuildContainer(ctx context.Context) *dig.Container {
	...
	mustProvide("postgres.SectionRepository", postgres.NewSectionRepository)
	...
	mustProvide("postgres.QuestionBankRepository", postgres.NewQuestionBankRepository)
	...
	mustProvide("service.SectionService", service.NewSectionService)
	mustProvide("service.SectionLessonPlanService", service.NewSectionLessonPlanService)
	...
	mustProvide("service.ResourceAISummaryService", service.NewResourceAISummaryService)
	...
	mustProvide("service.CourseDesignService", service.NewCourseDesignService)
	mustProvide("service.QuestionBankService", service.NewQuestionBankService)
	...
	mustProvide("handlers.NewSectionHandler", handlers.NewSectionHandler)
	...
	mustProvide("handlers.NewCourseDesignHandler", handlers.NewCourseDesignHandler)
	mustProvide("handlers.NewQuestionBankHandler", handlers.NewQuestionBankHandler)
